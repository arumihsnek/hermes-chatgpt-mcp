# HERMES NATIVE CAPABILITIES MATRIX — DRAFT v0.20.2

**Source:** Hermes v0.20.2 (2026.8.16) · local HEAD 39cfd1ab41 · board hermes-chatgpt-mcp
**Evidence base:** t_2d568471 (synthesis), t_5caf4595 (native tools), t_c2257b50 (profiles), t_2d78d03f (skills), t_ad6925aa (runtime), t_ef94f514 (config), t_2499ad0a (attachments)
**Date:** 2026-08-19
**Status:** DRAFT — Do not edit repository or execute mutating Hermes commands
